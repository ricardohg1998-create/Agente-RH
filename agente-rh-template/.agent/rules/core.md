...
- **Analizador Semántico MCP**: OBLIGATORIO priorizar el uso de las herramientas MCP (`analyze_file_ast`, `get_symbol_references`) sobre la búsqueda en texto plano (`grep_search`) para explorar estructura de código, tipos y referencias.
