...
- `Pre-lanzamiento` (`pre-release`) -> Antes de deploy a produccion o staging.
...
4. Actualizar capa rapida de rain/ (
ow.md, current-state.md, stack.md si aplica).
...
- `.agent/workflows/pre-release.md`
- `.agent/workflows/qa-testing.md`
- `.agent/workflows/retrospectiva.md`
- `.agent/workflows/spike-investigacion.md`
