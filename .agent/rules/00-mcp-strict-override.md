...
"Related tools: view_file, grep_search, mcp_Metricasa-Semantic_get_symbol_references. Since I need to find where emails are sent, grep_search is too generic. I will use the specific tool mcp_Metricasa-Semantic_get_symbol_references instead."
